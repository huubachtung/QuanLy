...
class GetNotificationsUseCase implements UseCase<NotificationListResult, NoParams> {
...
class MarkNotificationReadUseCase implements UseCase<void, String> {
  ...
  @override
  Future<Either<Failure, void>> call(String params) => repository.markAsRead(params);
}
